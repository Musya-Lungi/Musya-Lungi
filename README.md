...
## 💼 **What I Do**
- **Frontend Development**: Intuitive, responsive UIs with React.js and modern JavaScript (ES6+).
- **Backend Development**: Scalable REST APIs using Node.js, Express.js, and MongoDB.
- **Full-Stack Projects**: Integration of frontend & backend with seamless data flow.
- **DevOps & Deployment**: GitHub Actions, Netlify, Vercel, Render, and Heroku for CI/CD.
